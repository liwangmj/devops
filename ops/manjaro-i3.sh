...
# 安装扩展应用
# yaourt -S fcitx-sogoupinyin wine winetricks electronic-wechat gitter nutstore teamviewer youdao-dict vlc steam deepin-screenshot pepper-flash diffmerge wps-office drawio-desktop-bin freeplane plantuml pencil google-webdesigner gimp inkscape blender davinci-resolve freecad devdocs-desktop zeal appimage-git wxhexeditor gvim atom eclipse-jee qtcreator mysql-workbench android-studio dbeaver netbeans intellij-idea-ultimate-edition pycharm-professional webstorm clion gitkraken kdesvn soapui jmeter chromedriver chromium firefox freerdp remmina wireshark-qt shadowsocks-qt5 shadowsocks packetsender filezilla thunderbird
